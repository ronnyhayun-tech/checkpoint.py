...
print(lowest_of_three(18, 42, 27))
print(lowest_of_three(10, 2, 5))
print(lowest_of_three(9, 90, 80))
...
if user_num1 <= user_num2 and user_num1 <= user_num3:
    ...
    if user_num2 <= user_num3:
        mid, high = user_num2, user_num3
    else:
        mid, high = user_num3, user_num2
elif user_num2 <= user_num1 and user_num2 <= user_num3:
    low = user_num2
    if user_num1 <= user_num3:
        mid, high = user_num1, user_num3
    else:
        mid, high = user_num3, user_num1
else:
    low = user_num3
    if user_num1 <= user_num2:
        mid, high = user_num1, user_num2
    else:
        mid, high = user_num2, user_num1
